...
you should be able to access all the functionality for three people: Abhishek Fatehpuria (me), my girlfriend,
and Michael Lannin (I know him from Net Impact——I'm not a stalker :P). In order to do this, I added data to the CSV
...
the program on the iOS simulator from xCode!
